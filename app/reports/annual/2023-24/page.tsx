...
const highlights = [
  {
    title: "Education",
    text: "Education and learning-support activities focused on community needs.",
  },
  {
    title: "Healthcare",
    text: "Health awareness and community wellbeing-oriented initiatives.",
  },
  {
    title: "Community Development",
    text: "Community-focused activities supporting local development priorities.",
  },
  {
    title: "Social Welfare",
    text: "Welfare-oriented initiatives intended to support communities.",
  },
];

export default function AnnualReport202324Page() {
  return (
    <main className="min-h-screen bg-[#F3F7F8] text-[#193247]">
      ...
      <div className="border-b border-[#D8E5E8] bg-white">
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <a
            href="/reports/annual/2023-24.pdf"
            download
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-2xl border border-[#D8E5E8] bg-white p-5 sm:p-6">
                ...
                <p className="mt-3 text-[10px] leading-6 text-gray-600">
                  The Annual Report 2023–24 provides a
                  consolidated overview of the Trust&apos;s
                  activities, programme areas and
                  organisational information during the
                  reporting period.
                </p>

                <p className="mt-3 text-[10px] leading-6 text-gray-600">
                  The report is intended to provide
                  stakeholders with an accessible overview
